...
from NxSanfran.NxLib import requests
from NxSanfran.NxLib.requests.packages.urllib3.poolmanager import PoolManager
from NxSanfran.NxLib.requests.adapters import HTTPAdapter
